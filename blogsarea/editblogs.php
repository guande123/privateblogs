...
<style type="text/css">
 ...
 <body>
	 ...
	 <content>
	 <div class="fuwenben">
		 <p class="p_title"><span>请输出博文标题：</span>&nbsp;&nbsp;&nbsp;&nbsp;<input id="title1" type="text" value="<?php echo $title;?>"/></p>
	 ...
	 <form id="form1" action="saveContent.php" method="POST">
		...
		<input id="verifyCode" type="hidden" name="verifyCode" value="<?php echo $verifyCode;?>" />
		<input id="blogId" type="hidden" name="verifyCode" value="<?php echo $blogId;?>" />
