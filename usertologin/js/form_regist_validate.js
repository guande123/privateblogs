//表单输出验证
   document.write("<script language='javascript' src='checks.js'></script>");
   ...
   function formValidate(){
	   ...
	   var url = "../usertologin/regist_validate.php?username=";
	   url=url+inputNameObj.value;
	   url=url+"&password="+inputPasswordObj.value;
	   url=url+"&email="+inputEmailObj.value;
	   url=url+"&phonenumber="+inputPhoneNumberObj.value;
